...
<section class="clientes py-4 my-5">
    <div class="container">
...
<section class="pilares mb-5 py-4">
    <div class="container">
        <div class="row justify-content-center flex-column text-center mb-4">
            <h2><?php echo get_field('titulo_pilares')?></h2>
            <hr>
            <p class="mt-4 text-center"><?php echo get_field('sobre_pilares')?></p>
        </div>
        <div class="pilar">
        <div class="line"></div>
        <div class="row justify-content-between h-100">
            <?php
            $total = count(get_field('pilares'));
            while(have_rows('pilares')){ the_row(); ?>
                <div class="box text-center" style="width: calc(100% / <?php echo $total; ?>)">
                    ...
                    <p><?php echo get_sub_field('conteudo_'); ?></p>
                </div>
            <?php } ?>
        </div>
        </div>
...
<section class="porq mb-5 py-5 text-white">
    <div class="container">
